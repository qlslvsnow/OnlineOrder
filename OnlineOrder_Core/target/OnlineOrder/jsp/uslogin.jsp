    ...
    <div id="loginContent"> 　　　　　　　　　　　
        <form action="login" method="post" autocomplete="off">
            <p class="pass-form-item">
                ...
                <div id="validateUserNameCheck"><s:fielderror><s:param>User.userName</s:param></s:fielderror></div>
            ...
            <p class="pass-form-item">
                ...
                <div id="validatePasswordCheck"><s:fielderror><s:param>User.password</s:param></s:fielderror></div>
